...
const FilterNav = ({ activeFilter, onFilterChange, searchQuery, onSearchChange }) => {
  ...
  return (
    <div className="flex flex-col md:flex-row items-stretch justify-between px-2 pt-2 pb-[2.375rem] md:p-8 border-x border-foreground/10">
      {/* Navigation Links */}
      ...
      <div className="relative order-1 lg:order-2">
        <input
          ...
          className="w-full lg:w-[280px] px-4 py-2 pr-10 text-sm bg-foreground/5 border border-foreground/10 rounded-[2px] text-foreground placeholder:text-foreground/60 focus:outline-none focus:border-foreground/80 transition-colors duration-200"
        />
