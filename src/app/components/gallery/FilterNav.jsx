    ...
    <div className="flex items-center justify-between p-8 border-x border-foreground/10">
      ...
      <div className="relative">
        <input
          ...
          className="w-[200px] lg:w-[280px] px-4 py-2 pr-10 text-sm bg-foreground/5 border border-foreground/10 rounded-[2px] text-foreground placeholder:text-foreground/60 focus:outline-none focus:border-foreground/80 transition-colors duration-200"
        />
