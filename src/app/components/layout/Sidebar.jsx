  ...
  return (
    <Tag className={
      ...
      <div className={
        ...
        <div className={`relative lg:flex-grow min-h-0 flex flex-col overflow-hidden ${
            ...
            <div className="py-4">
              {debouncedQuery.trim() === '' ? (
                ...
                <div className="flex flex-col items-center justify-center py-16 text-textLow select-none">
                  <FontAwesomeIcon icon={['far', 'search']} className="w-6 h-6 mb-3 opacity-20" />
                  <p className="text-sm opacity-60">Type to search components...</p>
                ...
                <div className="flex flex-col items-center justify-center py-16 text-textLow select-none">
                  <div className="w-10 h-10 rounded-full bg-foreground/5 flex items-center justify-center mb-3">
                    <FontAwesomeIcon icon={['far', 'search']} className="w-4 h-4 opacity-40" />
                  </div>
                    ...
                    <div key={category}>
                      <ul className="list-none flex flex-col gap-0.5">
                        {items.map(item => {
                          ...
                          const isActive = currentLink === item.path || currentComponentName === slug
                          return (
                            <li key={item.path}>
                              <Link
                                to={item.path}
                    ...
                    <AccordionItem key={accordionValue} value={accordionValue}>
                      <AccordionTrigger>
                        <p className='text-link font-medium text-foreground'>
                          {label} <span className='text-textLow'> • {components.length}</span>
                        </p>
                      </AccordionTrigger>
                      <AccordionContent>
