...
import ConfigSidebar from '../components/detail/ConfigSidebar.jsx'
    ...
    return (
      <div className="bg-background text-foreground pt-[64px] min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">The component &ldquo;{componentName}&rdquo; could not be found.</p>
        </div>
      </div>
    )
  }
    ...
    <>
      ...
      <div className="bg-background text-foreground h-full overflow-hidden">
        <div className="flex flex-col lg:flex-row lg:h-[calc(100vh-4.5rem)]">
          ...
          <main className="flex-1 flex flex-col bg-base-medium w-full items-center lg:overflow-hidden lg:h-full">
            ...
            <div className="w-full max-w-[1440px] pt-2 px-2">
              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 sm:gap-4">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  >
                    <FontAwesomeIcon icon={['far', 'refresh']} className='w-4 h-4 opacity-60'/>
                  </Button>
                </div>
              </div>
            </div>
