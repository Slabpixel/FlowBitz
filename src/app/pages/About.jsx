                ...
                <div className="mx-auto">
                  <div className="prose prose-lg max-w-none text-muted-foreground">
                    <p className="text-lg leading-relaxed mb-6">
                      <strong>The Challenge:</strong> Webflow's native
                      animations are limited. While perfect for basic
                      interactions, creating professional-grade animations
                      requires manual GSAP coding - a barrier that excludes most
                      designers and requires expensive developer resources.
                    </p>
                    <p className="text-lg leading-relaxed mb-6">
                      <strong>Our Solution:</strong> FlowBitz bridges this gap
                      with {componentCount} pre-built, GSAP-powered components
                      that work through simple HTML attributes. No JavaScript
                      knowledge required - just add attributes to any Webflow
                      element and get professional animations instantly.
                    </p>
                    <p className="text-lg leading-relaxed mb-6">
                      <strong>The Impact:</strong> We've democratized advanced
                      web animations, making them accessible to designers,
                      agencies, and independent creators worldwide. FlowBitz
                      levels the playing field, allowing anyone to create
                      stunning animations that previously required expensive
                      development resources.
                    </p>
                    <p className="text-lg leading-relaxed">
                      <strong>Our Commitment:</strong> FlowBitz remains
                      completely free and open-source because we believe
                      professional web animations shouldn't be a luxury. Every
                      designer deserves access to the same powerful tools used
                      by top agencies, regardless of budget or technical
                      expertise.
                    </p>
                  </div>
                </div>
