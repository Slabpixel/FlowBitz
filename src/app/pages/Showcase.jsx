    ...
    <>
      ...
      <section className="bg-background text-foreground min-h-screen relative overflow-hidden pb-16 md:pb-10">
        <div className="max-w-[1200px] lg:mx-auto mx-2 relative z-[2] border-x border-foreground/10">
          {/* Hero Section */}
          <div wb-component="smart-animate" className="flex flex-col items-center mx-auto max-w-[99%] md:max-w-[475px] px-2 md:px-0 md:mx-auto text-center pt-6 md:py-14 gap-5 md:gap-4">
            <div className="bg-foreground/10 h-[30px] w-fit px-4 flex items-center justify-center gap-1">
              <span className='text-link font-medium text-foreground'>Made with</span>
        ...
        {/* End Hero Section */}
          ...
          {/* Showcase Gallery */}
          <div wb-component="smart-animate" className="grid grid-cols-1 mt-12 md:mt-0 mx-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {submitStatus === 'success' ? (
          <div className="flex flex-col items-center gap-3 py-4 text-center">
            ...
            <p className="text-sm text-muted-foreground">
              We'll take a look and get back to you soon. Thanks for sharing your work!
            </p>
            <Button
          ...
          <div className="flex flex-col items-center gap-3 py-4 text-center">
            ...
            <h3 className="text-lg font-semibold text-foreground">Submission Failed</h3>
            <p className="text-sm text-muted-foreground">
              Something went wrong. Please try again or contact us at flowbitz@slabpixel.com
            </p>
            <Button
          ...
          <div className='flex flex-col gap-6 md:gap-10'>
            <div className="flex flex-col gap-4">
              <div className='flex flex-col gap-3'>
                ...
                <p className='inter-med-40 text-foreground'>Share Your <br/> #MadewithFlowbitz Project</p>
              </div>

              <p className="inter-reg-18 text-text-medium opacity-80">
                Share your cool FlowBitz project! Fill out this <br/> form to feature your work.
              </p>
            </div>

            <form onSubmit={handleSubmit}>
              <div className='mb-3'>
                <label htmlFor="modal-email" className="block text-link text-foreground font-medium mb-2">
                  Your Email
                </label>
                <Input
                  id="modal-email"
              ...
              <div className='mb-3'>
                <label htmlFor="modal-url" className="block text-link text-foreground font-medium mb-2">
                  Website URL
                </label>
                <Input
                  id="modal-url"
              ...
              <div className='mb-10 pb-6'>
                <label htmlFor="modal-components" className="block text-link text-foreground font-medium mb-2">
              ...
              >
                {isSubmitting ? (
                  ...
                  <>
                    Submit
                    <FontAwesomeIcon icon={['far', 'arrow-right']} className='w-3 h-3 opacity-60'/>
                  </>
                )}
              </Button>
