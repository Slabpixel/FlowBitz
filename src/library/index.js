...
export {
  createOnceAnimationConfig,
  calculateScrollTriggerStart,
} from "./utils/animation/scrollTriggerHelper.js";
...
export {
  ...
  getComponent,
  getAllComponentKeys,
} from "./data/componentsMetadata.js";
export {
  loadComponent,
  getAvailableComponents,
  componentExists,
  getComponentFileName,
} from "./data/componentsRegistry.js";
...
export {
  ...
  componentExists as helperComponentExists,
  getAllComponentNames,
  searchComponents,
} from "./utils/validation/componentHelper.js";
