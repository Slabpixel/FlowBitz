...
export const componentsMetadata = {
  ...
  "split-text": {
    ...
    file: "splitText.js",
    installationNotes:
      "Works with any text element like <h1>, <h2>, <p>, <span>, <div>, etc. The component automatically splits the text content and wraps each part in spans for animation.",
    hoverPreview: true,
    attributes: [
      {
        name: "wb-component",
    ...
    example: {
      ...
      description:
        "Each word animates separately with customizable split type and timing",
    },
  },
  ...
  "gradient-text": {
    ...
    installationNotes:
      "Perfect for headings like <h1>, <h2>, <h3> or any text element. The gradient animation works best with larger text sizes for better visual impact.",
    hoverPreview: false,
    attributes: [
      {
        name: "wb-component",
      ...
      },
      {
        name: "wb-colors",
        description:
          'Gradient colors (comma-separated or JSON array). Supports: hex (#FF5733), rgb/rgba, hsl/hsla, named colors (red, blue), CSS variables (var(--color)). Example: "#FF5733, rgb(64, 255, 170), var(--primary)"',
  ...
  "text-type": {
    ...
    file: "textType.js",
    installationNotes:
      "Use with <span> elements inside headings or paragraphs. The component replaces the text content with a typewriter animation. Works best with monospace fonts.",
    hoverPreview: false,
    attributes: [
      {
        name: "wb-component",
      ...
      },
      {
        ...
        description:
          'Cursor character style: "underscore", "pipe", "dot", "block", "full-block"',
        default: "pipe",
        inputType: "dropdown",
      ...
      },
      {
        name: "wb-text-3",
        description:
          "Third text to type, you can add more texts by adding wb-text-4, wb-text-5, etc.",
        default: "",
        inputType: "text",
      },
      {
  ...
  "blur-text": {
    ...
    file: "blurText.js",
    installationNotes:
      "Works with any text element like <h1>, <h2>, <p>, <span>. The blur effect is applied on scroll or hover, revealing text from blur to clear.",
    hoverPreview: true,
    attributes: [
      {
        name: "wb-component",
  ...
  "shiny-text": {
    ...
    file: "shinyText.js",
    installationNotes:
      "Best used with larger headings like <h1>, <h2> or prominent text elements. The shine effect creates a moving gradient overlay across the text.",
    hoverPreview: false,
    attributes: [
      {
        name: "wb-component",
      ...
      },
      {
        name: "wb-text-color",
        description:
          "Base text color (inherits from Webflow element if not specified). Supports: hex (#FF5733), rgb/rgba, hsl/hsla, named colors (red, blue), CSS variables (var(--color))",
        default: "#0a70ff",
        inputType: "color",
        supportsAlpha: true,
      },
      {
        name: "wb-shine-color",
        description:
          "Shine color. Supports: hex (#FF5733), rgb/rgba, hsl/hsla, named colors (red, blue), CSS variables (var(--color))",
        default: "#8cbcff",
        inputType: "color",
        supportsAlpha: true,
      },
  ...
  "count-up": {
    ...
    file: "countUp.js",
    installationNotes:
      "Perfect for statistics, numbers, or counters. Use with <span>, <div>, or any element containing numeric values. The component animates from a starting number to a target value.",
    hoverPreview: true,
    attributes: [
      {
        name: "wb-component",
  ...
  "decrypted-text": {
    ...
    installationNotes:
      "Great for dramatic reveals and tech-themed content. Works with any text element like <h1>, <h2>, <p>, <span>. The component scrambles characters before revealing the final text.",
    hoverPreview: true,
    attributes: [
      {
        name: "wb-component",
    ...
    example: {
      ...
      description:
        "Matrix-style decryption effects with customizable characters",
    },
  },
  ...
  "scramble-text": {
    ...
    installationNotes:
      "Interactive hover effect that scrambles text on mouse proximity. Works with any text element like <p>, <span>, <div>. Best with monospace fonts for consistent character spacing.",
    hoverPreview: false,
    attributes: [
      {
        name: "wb-component",
      ...
      },
      {
        name: "wb-font",
        description:
          "Font family for consistent character width (recommended for best results)",
        default: "monospace",
        inputType: "dropdown",
        options: [
          "monospace",
        ...
        warning:
          '⚠️ Using "inherit" may cause width inconsistencies with scramble characters',
      },
      {
        name: "wb-radius",
    ...
    example: {
      ...
      description:
        "Interactive character scrambling with customizable radius, duration, and speed",
    },
  },
  ...
  "variable-proximity": {
    ...
    installationNotes:
      "Requires variable fonts that support weight variations. Works with any text element like <h1>, <h2>, <p>, <span>. The font weight changes based on mouse proximity.",
    hoverPreview: false,
    attributes: [
      {
        name: "wb-component",
    ...
    example: {
      ...
      description:
        "Mouse proximity font variations with customizable weight and size sliders",
    },
  },
  ...
  "rotating-text": {
    ...
    installationNotes:
      "Use with <span> elements inside headings or paragraphs. The component cycles through different text options with smooth transitions. Great for highlighting multiple features or benefits.",
    hoverPreview: false,
    attributes: [
      {
        name: "wb-component",
      ...
      },
      {
        ...
        description:
          "Background color for the text container. Supports: hex (#FF5733), rgb/rgba, hsl/hsla, named colors (red, blue), CSS variables (var(--color))",
        default: "",
        inputType: "color",
        supportsAlpha: true,
      },
      {
        name: "wb-text-color",
        description:
          "Text color for the rotating text. Supports: hex (#FF5733), rgb/rgba, hsl/hsla, named colors (red, blue), CSS variables (var(--color))",
        default: "",
        inputType: "color",
        supportsAlpha: true,
      },
      {
        ...
        description:
          "Border radius for the text container (e.g., 8px, 1rem, 50%)",
        default: "",
        inputType: "text",
      },
      {
      ...
      },
      {
        name: "wb-text-3",
        description:
          "Third rotating text, you can add more texts by adding wb-text-4, wb-text-5, etc.",
        default: "",
        inputType: "text",
      },
      {
    ...
    example: {
      ...
      description:
        "Auto-rotating text with stagger effects, background color, text color, border radius, and automatic centering",
    },
  },
  ...
  "text-pressure": {
    ...
    installationNotes:
      "Requires variable fonts (like Compressa VF, Recursive, Roboto Flex). Works with any text element. The component dynamically changes font weight, width, and italic based on mouse proximity.",
    hoverPreview: false,
    attributes: [
      {
        name: "wb-component",
      ...
      },
      {
        name: "wb-text-color",
        description:
          "Text color (optional, uses currentColor by default for theme compatibility). Supports: hex (#FF5733), rgb/rgba, hsl/hsla, named colors (red, blue), CSS variables (var(--color))",
      ...
      },
      {
        ...
        description:
          "Stroke color for text outline (optional). Supports: hex (#FF5733), rgb/rgba, hsl/hsla, named colors (red, blue), CSS variables (var(--color))",
        default: "",
        inputType: "color",
        supportsAlpha: true,
      },
    ...
    example: {
      ...
      description:
        "Mouse proximity font variations with Compressa VF variable font",
    },
  },
  ...
  shuffle: {
    name: "Shuffle",
    description:
      "Character-based sliding shuffle effects with customizable direction and scrambling",
    category: "text",
    file: "shuffle.js",
    installationNotes:
      "Works with any text element like <h1>, <h2>, <p>, <span>. The component creates sliding shuffle effects with characters moving in different directions. Best with monospace fonts.",
    hoverPreview: false,
    attributes: [
      {
        name: "wb-component",
      ...
      },
      {
        name: "wb-color-from",
        description:
          "Starting color for animation (optional). Supports: hex (#FF5733), rgb/rgba, hsl/hsla, named colors (red, blue), CSS variables (var(--color))",
        default: "",
        inputType: "color",
        supportsAlpha: true,
      },
      {
        name: "wb-color-to",
        description:
          "Ending color for animation (optional). Supports: hex (#FF5733), rgb/rgba, hsl/hsla, named colors (red, blue), CSS variables (var(--color))",
        default: "",
        inputType: "color",
        supportsAlpha: true,
      },
    ...
    example: {
      ...
      description:
        "Character-based sliding shuffle effects with customizable direction",
    },
  },
  ...
  "tooltip-text": {
    ...
    name: "Tooltip Text",
    description:
      "Hover tooltips for any text element with customizable positioning and styling",
    category: "text",
    file: "tooltipText.js",
    installationNotes:
      "Use with any text element like <span>, <a>, <strong>, <em>. The component adds a hover tooltip with customizable content, position, and styling.",
    hoverPreview: false,
    attributes: [
      {
        name: "wb-component",
      ...
      },
      {
        ...
        description:
          "Tooltip background color. Supports: hex (#FF5733), rgb/rgba, hsl/hsla, named colors (red, blue), CSS variables (var(--color))",
        default: "#000000",
        inputType: "color",
        supportsAlpha: true,
      },
      {
        ...
        description:
          "Tooltip text color. Supports: hex (#FF5733), rgb/rgba, hsl/hsla, named colors (red, blue), CSS variables (var(--color))",
        default: "#ffffff",
        inputType: "color",
        supportsAlpha: true,
      },
  ...
  "roll-text": {
    ...
    name: "Roll Text",
    description:
      "Vertical rolling text effect on hover by duplicating content and translating the container upward.",
    category: "text",
    file: "rollText.js",
    installationNotes:
      'Wrap your text with a <div wb-component="roll-text"> wrapper. The first child inside the wrapper must be one of: <div>, <p>, <a>, <span>, <h1>, <h2>, <h3>, <h4>, <h5> or <h6> containing the text. The wrapper becomes an inline-block overflow-hidden mask; on hover, the original line rolls up and the duplicate line replaces it.',
    hoverPreview: false,
    attributes: [
      {
        name: "wb-component",
      ...
      },
      {
        name: "wb-stagger",
        description:
          'Required when using wb-split-by="chars" or wb-split-by="words", ensure the text contains at least two characters/words to display the staggered roll animation as intended.',
        default: "0.05",
        unit: "ms",
        inputType: "slider",
    ...
    example: {
      ...
      description:
        "The content is duplicated and vertically rolled on hover; the duplicate line replaces the original.",
    },
  },
  ...
  "gradient-button": {
    ...
    installationNotes:
      "Use with <button>, <a>, or any clickable element. The component adds animated gradient background with customizable colors and hover effects.",
    attributes: [
      {
        name: "wb-component",
      ...
      },
      {
        name: "wb-text-color",
        description:
          "Text color for the button. Supports: hex (#FF5733), rgb/rgba, hsl/hsla, named colors (red, blue), CSS variables (var(--color))",
        default: "white",
        inputType: "color",
        supportsAlpha: true,
      },
    ...
    example: {
      ...
      description:
        "Animated gradient button with customizable colors and hover effects",
    },
  },
  ...
  "ripple-button": {
    name: "Ripple Button",
    description:
      "Button with Material Design ripple effect and scale animation on click",
    category: "button",
    file: "rippleButton.js",
    installationNotes:
      "Perfect for <button>, <a>, or any clickable element. Creates a Material Design ripple effect that spreads from the click point with customizable colors and duration.",
    attributes: [
      {
        name: "wb-component",
      ...
      },
      {
        ...
        description:
          "Ripple effect color. Supports: hex (#FF5733), rgb/rgba, hsl/hsla, named colors (red, blue), CSS variables (var(--color))",
    ...
    example: {
      ...
      description:
        "Button with Material Design ripple effect and scale animation that spreads from click point",
    },
  },
  ...
  "pulse-button": {
    name: "Pulse Button",
    description:
      "Button or link with gentle pulsing animation to draw attention. Works with both <button> and <a> elements.",
    category: "button",
    file: "pulseButton.js",
    installationNotes:
      "Use with <button>, <a>, or any element you want to draw attention to. Creates a gentle pulsing animation that can pause on hover. Great for call-to-action buttons.",
    attributes: [
      {
        name: "wb-component",
      ...
      },
      {
        name: "wb-speed",
        description:
          'Pulse animation speed: "slow", "normal", "fast", or custom duration',
        default: "normal",
        inputType: "dropdown",
    ...
    example: {
      ...
      description:
        "Button or link with gentle pulsing animation to draw attention to important actions",
    },
  },
  ...
  "magnetic-button": {
    ...
    description:
      "Button with magnetic attraction effect that follows mouse movement",
    category: "button",
    file: "magnet.js",
    installationNotes:
      "Use with <button>, <a>, or any interactive element. Creates a magnetic effect where the element follows mouse movement within a specified radius. Great for interactive buttons and links.",
    attributes: [
      {
        name: "wb-component",
    ...
    example: {
      ...
      description:
        "Button that follows mouse movement with magnetic attraction - the entire button (background, text, and all styling) moves together",
    },
  },
  ...
  "shimmer-button": {
    ...
    name: "Shimmer Button",
    description:
      "Button with shimmer effect on hover with customizable direction and color. Button color is inherited from Webflow CSS settings.",
    category: "button",
    file: "shimmerButton.js",
    installationNotes:
      "Use with <button>, <a>, or any clickable element. The component adds a shimmer effect on hover that moves across the button. Button background and text colors are inherited from your Webflow CSS settings.",
    attributes: [
      {
        name: "wb-component",
      ...
      },
      {
        ...
        description:
          "Shimmer effect color. Supports: hex (#FF5733), rgb/rgba, hsl/hsla, named colors (red, blue), CSS variables (var(--color))",
      ...
      },
      {
        ...
        description:
          'Direction of shimmer effect: "left", "right", "top", or "bottom"',
        default: "left",
        inputType: "dropdown",
      ...
      },
      {
        ...
        description:
          'Speed of shimmer animation: "slow" (0.7s), "medium" (0.5s), or "fast" (0.3s)',
        default: "medium",
        inputType: "dropdown",
      ...
      },
      {
        name: "wb-shadow",
        description:
          "Enable shadow effect on hover (shadow color is based on button color)",
        default: "true",
        inputType: "toggle",
      },
    ],
    example: {
      ...
      description:
        "Button with shimmer effect on hover. Button color is inherited from Webflow CSS settings.",
    },
  },
  ...
  "smart-animate": {
    name: "Smart Animate",
    description:
      "Animates the selected element and its direct children with smooth staggered transitions",
    category: "effect",
    file: "smartAnimate.js",
    installationNotes:
      "Use with any container element like <div>, <section>, <article>. The component animates the selected element first, then animates all direct children with customizable stagger timing. Perfect for revealing content sections.",
    hoverPreview: true,
    attributes: [
      {
        name: "wb-component",
    ...
    example: {
      ...
      description:
        "Animates the container and all direct children with smooth staggered transitions from bottom to top",
    },
  },
  ...
  "3d-card-hover": {
    ...
    name: "3D Card Hover",
    description:
      "3D tilt on hover effect with configurable perspective and rotation sensitivity",
    category: "effect",
    file: "3dCardHover.js",
    ...
    attributes: [
      {
        name: "wb-component",
        description: "Enable 3D Card Hover",
        default: "3d-card-hover",
        inputType: "text",
        required: true,
      },
      {
        name: "wb-perspective",
        description: "Perspective value (px)",
        default: "800",
        unit: "px",
        inputType: "slider",
        sliderConfig: { min: 100, max: 2000, step: 50 },
      },
      {
        name: "wb-rotate-divisor",
        description: "Rotation divisor factor (smaller = more sensitive)",
        default: "15",
        inputType: "slider",
      ...
      {
        name: "wb-transition",
        description: "Transition CSS for transform",
        default: "transform 200ms linear",
        inputType: "text",
      },
    ],
    example: {
  ...
  "outline-gradient": {
    ...
    installationNotes:
      "Works with any block-level element like <div>, <button>, etc. The component creates an animated gradient border that rotates smoothly using CSS @property. Make sure to apply position: relative or position: absolute to the element.",
    attributes: [
      {
        name: "wb-component",
      ...
      },
      {
        name: "wb-colors",
        description:
          'Gradient colors with stops. Supports multiple formats: "red, blue, green" or "#833AB4 0%, #FD1D1D 50%, #FCB045 100%". Colors will be evenly distributed if no percentages provided.',
  ...
  >
    <h2 class="text-3xl font-bold">Gradient Border</h2>
      ...
      description:
        "Smooth rotating gradient border that accelerates on hover. Works perfectly with rounded corners.",
    },
  },
  ...
  "image-trail": {
    ...
    name: "Image Trail",
    description:
      "Animated image trail effect following mouse movement with 8 different animation variants",
    category: "effect",
    file: "imageTrail.js",
    installationNotes:
      "Works with any container element. Provide image URLs via wb-image-1, wb-image-2, wb-image-3, etc. (similar to text-type). Choose from 8 stunning animation variants. Requires GSAP for animations. Perfect for creative portfolios and interactive showcases.",
    attributes: [
      {
        name: "wb-component",
      ...
      },
      {
        name: "wb-image-4",
        description:
          "Fourth image URL (add more with wb-image-5, wb-image-6, etc.)",
        default: "",
        inputType: "text",
      },
      {
        name: "wb-variant",
        description:
          "Animation variant (1-8): 1=Basic fade, 2=Scale+brightness, 3=Scatter upward, 4=Direction-based, 5=Rotation, 6=Speed effects, 7=Multiple visible, 8=3D perspective",
        default: "1",
        inputType: "dropdown",
...
>
  <h2 class="text-2xl font-bold text-center pointer-events-none">
    Move Your Mouse Here
      ...
      description:
        "Images follow cursor with smooth animations. Add more images with wb-image-4, wb-image-5, etc. Try different variants (1-8) for unique effects.",
    },
  },
  ...
  "hover-zoom": {
    ...
    name: "Hover Zoom",
    description:
      "Zoom effect on hover with parallax movement that follows mouse direction",
    category: "effect",
    file: "hoverZoom.js",
    installationNotes:
      "Works with img elements, divs with background images, or divs containing img elements. The image zooms on hover and moves in the opposite direction of the mouse cursor for a dynamic parallax effect.",
    attributes: [
      {
        name: "wb-component",
      ...
      },
      {
        name: "wb-zoom-scale",
        description:
          "Zoom scale on hover (1 = no zoom, 1.5 = 50% zoom, 2 = 100% zoom). Parallax movement is automatically calculated based on this value to prevent overflow.",
        default: "1.5",
        inputType: "slider",
...
/>`,
      description:
        "Image zooms on hover and moves in opposite direction of mouse cursor. Parallax movement is automatically calculated based on zoom scale to prevent overflow. Works with img tags, background images, or nested images.",
    },
  },
  ...
  "matrix-rain": {
    ...
    description: "Matrix Digital Rain background effect using Canvas 2D API",
    category: "background",
    file: "matrixRain.js",
    installationNotes:
    ...
    attributes: [
      ...
      {
        name: "wb-font-size",
        description: "Font size for characters. Supports: px, rem, em",
        default: "18px",
        inputType: "text",
        required: false,
      },
      {
        name: "wb-background",
        description:
          "Background color for the fade trail. Supports hex, rgba, hsla",
        default: "#000000",
        inputType: "color",
        supportsAlpha: true,
      },
      {
        name: "wb-text-alpha",
        description: "Trail alpha (fade strength)",
        default: "0.05",
        inputType: "slider",
        sliderConfig: { min: 0.05, max: 1.0, step: 0.05 },
      },
      {
        name: "wb-speed",
        description:
          "Speed (interval between animation frames) in milliseconds",
        default: "40",
        inputType: "slider",
        unit: "ms",
        sliderConfig: { min: 5, max: 200, step: 5 },
      },
      {
        name: "wb-char-mode",
        description: "Character mode: matrix or binary",
        default: "matrix",
        inputType: "dropdown",
        options: ["matrix", "binary"],
      },
      {
        name: "wb-text-color",
        description: "Character color. Supports hex, rgba, hsla",
        default: "#00FF00",
        inputType: "color",
        supportsAlpha: false,
      },
      {
        name: "wb-highlight-head",
        description: "Highlight the head character of each column",
        default: "false",
        inputType: "toggle",
      },
    ],
...
export const getFilteredComponentKeys = () => {
  ...
  return Object.keys(componentsMetadata).filter(
    (key) => !disabledComponents.includes(key),
  );
};
