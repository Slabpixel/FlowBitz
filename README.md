...
[![Version](https://img.shields.io/badge/version-2.4.2-blue.svg)](https://github.com/Slabpixel/FlowBitz)
...
- `@2.4.2` — pinned release
- `@beta` — beta channel

```html
<!-- Stable UMD -->
<script src="https://cdn.jsdelivr.net/npm/flowbitz@2.4.2/dist/flowbitz.umd.js"></script>

<!-- ES module -->
<script type="module">
  import FlowBitz from 'https://cdn.jsdelivr.net/npm/flowbitz@2.4.2/dist/flowbitz.es.js';
  await FlowBitz.init();
</script>
```
...
Deployments run on Vercel (`npm run deploy:*`) with immutable, versioned CDN paths like `flowbitz.dev/v2.4.2/`.
