...
[![Version](https://img.shields.io/badge/version-2.3.2-blue.svg)](https://github.com/Slabpixel/FlowBitz)
...
<!-- ES module -->
<script type="module">
  import FlowBitz from 'https://cdn.jsdelivr.net/npm/flowbitz@2.3.2/dist/flowbitz.es.js';
  await FlowBitz.init();
</script>
```
...
Deployments run on Vercel (`npm run deploy:*`) with immutable, versioned CDN paths like `flowbitz.dev/v2.3.2/`.
