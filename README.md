...
[![Version](https://img.shields.io/badge/version-2.4.3-blue.svg)](https://github.com/Slabpixel/FlowBitz)
...
- `@2.4.3` — pinned release
- `@beta` — beta channel

```html
<!-- Stable UMD -->
<script src="https://cdn.jsdelivr.net/npm/flowbitz@2.4.3/dist/flowbitz.umd.js"></script>

<!-- ES module -->
<script type="module">
  import FlowBitz from 'https://cdn.jsdelivr.net/npm/flowbitz@2.4.3/dist/flowbitz.es.js';
  await FlowBitz.init();
</script>
```
